# Some tricks for debugging hyperboria issues using traffic analysis

Traffic analysis on hyperboria is stupidly hard because everything is encrypted point to point.
