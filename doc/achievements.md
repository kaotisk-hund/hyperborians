...
3. Build hyperboria from source
4. Successfully peer with somebody.
5. Run only the latest version of hyperboria on all your nodes.
...
8. Create a `~/.hyperboriaadmin` file for use with the admin api.
...
19. Blag about hyperboria or Project Meshnet.
20. Design some form of rich media for Project Meshnet (graphics, video, animation, audio, presentation slides).
21. Discover a bug in hyperboria, and give it a memorable name.
22. Host or register a hyperboria, Project Meshnet, or Mesh-local mailing list.
...
26. Build hyperboria on an android phone.
...
34. Cross compile hyperboria for another platform.
35. Contribute to [Hyperboria's news agency](http://news.hyperboria.net/).
36. Document an undocumented function or component of hyperboria.
37. Implement a function or component of hyperboria in an alternate language
38. Translate an article into another language (and maintain it).
39. Update hyperboria without pinging out on IRC.
40. Configure an authorizedPassword without restarting hyperboria.
41. Find out whether your home router can run hyperboria: [OpenWrt table of hardware](http://wiki.openwrt.org/toh/start)
42. Try out the [Meshbox firmware](https://github.com/seattlemeshnet/meshbox) on your home router.
43. Harden your hyperboria OpenWrt router by building OpenWrt with hyperboria from source and make sure [seccomp](http://lwn.net/Articles/475043/), [SSP](http://lwn.net/Articles/584225/) and [RELRO](http://tk-blog.blogspot.de/2009/02/relro-not-so-well-known-memory.html) are enabled. Using [musl](http://www.musl-libc.org/) instead of [uClibc](http://www.uclibc.org/) may make you sleep even better. See [buildsdk.sh](https://github.com/SeattleMeshnet/meshbox/blob/master/buildsdk.sh) to see how this can work.
44. Monitor your nodes' hyperboria preformance and make pretty graphs with munin (hint: [here's a nice munin plugin to help](https://github.com/thefinn93/munin-plugins/blob/master/hyperboria/hyperboria_bandwidth.py))
...
* **Source code is always better**. At this point in time, the most authoritative definition of the hyperboria protocol is [hyperboria's github repository](https://github.com/cjdelisle/hyperboria). If you are using another source, it is far more likely to be out of date.
