...
hyperboria recently closed the issue tracker on his [hyperboria repo](http://github.com/cjdelisle/hyperboria) on the basis that it had the effect of encouraging people to submit errors, then wander off feeling like they had done their part in solving the problem (my words, not his (--ansuz)).
...
To make up for its absence, however, we decided to provide [a fork of hyperboria](http://github.com/hyperboria/hyperboria), with [its own issue tracker](https://github.com/hyperboria/hyperboria/issues) which would be maintained by the community. There are quite a few of us who care enough about this project to invest our time in improving things, however, it should be understood that:

1. like hyperboria, we are contributing our own personal time to do so
...
With that in mind, the [remarkably small group](https://github.com/orgs/hyperboria/people) who have pushed to curate our documentation and maintain our hyperboria fork could really use some help.
