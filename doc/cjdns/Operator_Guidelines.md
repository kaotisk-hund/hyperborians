...
DO NOT transfer peering credentials over any sort of plaintext medium, such as IRC or unencrypted email. It's probably also a good idea to use a service like [EZCrypt](https://ezcrypt.it) (also available [on Hyperboria](http://hyperboria.ezcrypt.it)) or send your peering details via encrypted email with PGP.
