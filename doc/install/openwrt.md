# Running hyperboria on commodity routers w/ OpenWrt

From: https://www.reddit.com/r/darknetplan/comments/2lmpqg/running_hyperboria_on_commodity_routers_w_openwrt/

Since the assumption pops up every other day that hyperboria wouldn't run on commodity routers:
...
- Follow the installation instructions in the Readme file mentioned above, to compile an OpenWrt firmware image including hyperboria and the LuCI web interface.
...
You will find help in #hyperboria on EFnet if you run into problems trying out hyperboria with OpenWrt.
