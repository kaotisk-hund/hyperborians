## hyperboria google summer of code
...
1. Get funding! Fixing hyperboria is hard work, and it takes a lot of time. A precedent of funding from google might make it easier to pick up funding from other sources.
...
### hyperboria on the Freifunk backbone (BBB) and network (IC-VPN)
...
- link hyperboria islands in the community
- automate the tunnel setup on leaf nodes

TODO: need to think about how remote-friendly this idea is

### Continuous simulations and benchmarks of hyperboria

- [HACKING.md#simulating](https://github.com/cjdelisle/hyperboria/blob/master/HACKING.md#simulating)
- [hyperboria-testbed](https://github.com/lgierth/hyperboria-testbed)
